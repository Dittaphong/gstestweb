...
<div class="row">
  ...
  <div class="col-md-6">
    <div class="media clearfix header-bottom" style="padding-bottom:20px">
      ...
      <div class="media-body"> <a href="<?php echo site_url(); ?>/Faculty/Officerinfo/<?php echo $Result['AdviserList']['OFFICERID']?>"> <span><?php echo $Result['AdviserList']['OFFICERPOSITION']." ".$Result['AdviserList']['OFFICERNAME']."  ".$Result['AdviserList']['OFFICERSURNAME'];?></span> </a><br>
...
<!-- <div class="row">
  ...
  <button id="app_success" class="btn btn-success" type="button" onClick="window.location.href='<?php echo site_url(); ?>/Faculty/AdvisorApproved/<?php echo $Result['DocAdviser'][0]['APPOINT_AVISER_ID']; ?>'"><i class="glyphicon glyphicon-ok"></i> <span>บันทึก</span></button>
  <?php else: ?>
  ...
  <button id="app_success" style="display:none;" class="btn btn-success" type="button" onClick="window.location.href='<?php echo site_url(); ?>/Faculty/AdvisorApproved/<?php echo $Result['DocAdviser'][0]['APPOINT_AVISER_IS_THESIS_ID']; ?>'"><i class="glyphicon glyphicon-ok"></i> <span>บันทึก</span></button>
  <?php endif; ?>
</div> -->
<div class='row '> </div>
<hr>
<div class='row '> </div>
<?php $this->load->view('Faculty/Pages/Students/Widget/ExamApproved'); ?>
