      ...
      <div class="form-group">
        ...
        <div class="col-md-9">
          <select id="STDYLEVEL" name="LEVELID" style="display: none;" >
            <option value="999">ระดับปริญญา</option>
            <?php foreach ($Result['STDYLEVEL'] as $Result['STDYLEVEL']): ?>
            <option <?php if ($Result['STDYLEVEL']['LEVELID']==$Result['PROGRAM'][0]['LEVELID']): ?>
												selected="selected"
											<?php endif; ?>
      ...
      <div class="form-group">
        ...
        <div class="col-md-9">
          <input type="text" class="form-control" placeholder="ชื่อเต็ม (ไทย)"
									name="PROGRAMNAME"
									value="<?php
									$this->debuger->NullObj($Result['PROGRAM'][0]['PROGRAMNAME']); ?>">
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="col-md-9">
          <input type="text" class="form-control" placeholder="ชื่อย่อ (ไทย)"
									name="PROGRAMABB"
									value="<?php
									$this->debuger->NullObj($Result['PROGRAM'][0]['PROGRAMABB']); ?>">
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="col-md-9">
          <input type="text" class="form-control" placeholder="ชื่อเต็ม (ภาษาอังกฤษ)"
									name="PROGRAMNAMEENG"
									value="<?php
									$this->debuger->NullObj($Result['PROGRAM'][0]['PROGRAMNAMEENG']); ?>">
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="col-md-9">
          <input type="text" class="form-control" placeholder="ชื่อย่อ (ภาษาอังกฤษ)"
									name="PROGRAMABBENG"
									value="<?php
									$this->debuger->NullObj($Result['PROGRAM'][0]['PROGRAMABBENG']); ?>">
        </div>
      </div>
    </div>
  </div>
