...
<?php if ($Result['DocAdviser'][0]['DOCUMENTSTATUS']==1): ?>
<div class="alert alert-success"> <strong>บันทักสำเร็จ</strong> - เอกสารการแต่งตั้งอาจารย์ที่ปรึกษา ได้ทำการบันทึกเสร็จสิ้น </div>
<script>
...
<div class="row">
  ...
  <button id="app_success" class="btn btn-success" type="button" onClick="window.location.href='<?php echo site_url(); ?>/graduate/AdvisorApproved/<?php echo $this->debuger->NullObj($Result['DocAdviser'][0]['APPOINT_AVISER_IS_THESIS_ID']); ?>'"><i class="glyphicon glyphicon-ok"></i> <span>บันทึก</span></button>
  <?php else: ?>
  ...
  <button id="app_success" style="display:none;" class="btn btn-success" type="button" onClick="window.location.href='<?php echo site_url(); ?>/graduate/AdvisorApproved/<?php echo $this->debuger->NullObj($Result['DocAdviser'][0]['APPOINT_AVISER_IS_THESIS_ID']); ?>'"><i class="glyphicon glyphicon-ok"></i> <span>บันทึก</span></button>
  <?php endif; ?>
