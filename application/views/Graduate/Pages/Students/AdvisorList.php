        ...
        <table  class="table colored-header datatable project-list" role="grid" aria-describedby="datatable-column-filter_info">
          ...
          <tbody>
            ...
            <tr role="row" class="odd">
              <td><a href="<?php echo site_url(); ?>/graduate/StudentCommand/<?php echo $Result['STUDENTID']; ?>/ADVI" ><?php echo $Result['STUDENTCODE']; ?></a></td>
              <td><a href="<?php echo site_url(); ?>/graduate/StudentCommand/<?php echo $Result['STUDENTID']; ?>/ADVI" > <?php echo $Result['PREFIXNAME'].$Result['STUDENTNAME']." ".$Result['STUDENTSURNAME']; ?></a></td>
