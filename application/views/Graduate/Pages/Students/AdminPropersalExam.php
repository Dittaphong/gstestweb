...
<?php if($ExamDoc['EXAM_TYPE']==$ExamType){$e++;} ?>
<?php endforeach; ?>
      ...
      <div class="panel panel-warning">
        <div class="panel-heading">
          <h4 class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#coll<?php echo $ExamDoc['EXAM_ID'] ?>" aria-expanded="<?php echo $coll; ?>" class="<?php echo $collapsed; ?>">
            ...
            <?php else: ?>
            คำร้องขอสอบเค้าโครงค้นคว้าอิสระ
            <?php endif; ?>
      ...
      <div class="col-md-12">
        <div class="form-group">
          <label class="control-inline fancy-radio custom-bgcolor-green">
            ...
            <span><i></i>ผ่าน ดีมาก</span> </label>
          <label class="control-inline fancy-radio custom-bgcolor-green">
            <input type="radio" name="inline-radio1">
            <span><i></i>ผ่าน ดี</span> </label>
          <label class="control-inline fancy-radio custom-bgcolor-green">
            <input type="radio" name="inline-radio1">
            <span><i></i>ผ่าน แบบมีเงื่อนไข</span> </label>
          <label class="control-inline fancy-radio custom-bgcolor-green">
            <input type="radio" name="inline-radio1">
            <span><i></i>ไม่ผ่าน</span> </label>
        </div>
      </div>
      <div class="col-md-9">
