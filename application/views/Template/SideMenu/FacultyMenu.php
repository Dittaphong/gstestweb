...
<nav class="main-nav">
  <ul class="main-menu">
    ...
    <li><a href="<?php echo site_url();?>/faculty_controller/OfficerList" >
      <i class="fa fa-users"></i><span class="text"> ข้อมูลอาจารย์</span></a>
    </li>
    <li><a href="<?php echo site_url();?>/faculty_controller/ProgramsSearch" >
      <i class="glyphicon glyphicon-bookmark"></i><span class="text"> ข้อมูลหลักสูตร</span></a>
    </li>
    <li><a href="<?php echo site_url();?>/faculty_controller/SearchResearch" >
      <i class="glyphicon glyphicon-search"></i><span class="text"> ค้นหางานวิจัย</span></a>
    </li>
    <li><a href="<?php echo site_url();?>/faculty_controller/SearchThesis" >
